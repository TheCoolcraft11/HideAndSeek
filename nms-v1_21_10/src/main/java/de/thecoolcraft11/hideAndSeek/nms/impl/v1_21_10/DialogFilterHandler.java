...
public final class DialogFilterHandler {
    ...
    private Object rebuildDialogRegistry(ClientboundRegistryDataPacket original,
        ...
        try {
            ...
            ResourceLocation targetKey = ResourceLocation.fromNamespaceAndPath("hideandseek", "main");
            List<Object> newEntries = new ArrayList<>();

            for (Object entry : entries) {
                ResourceLocation entryId = extractResourceLocation(entry);
    ...
    private Object rebuildMainDialogEntry(Object originalEntry,
        ...
        try {
            ...
            ResourceLocation entryId = extractResourceLocation(originalEntry);
            if (entryId == null) {
                return null;
            }
