    ...
    public List<SettingSpec> settings() {
        return List.of(new BooleanSettingSpec("game.block-form.scale-to-block", false,
                ...
                new BooleanSettingSpec("game.blockstats.enabled", true,
                        ...
                        Material.BOOK, true),
                new BooleanSettingSpec("game.skinstats.show-names", false, "Show player names in Skin Statistics GUI",
                        Material.NAME_TAG, true),
                new BooleanSettingSpec("game.skinstats.enabled", true,
                        "If the SkinStats GUI should be enabled (Only relevant when playing in SKIN Mode)",
                        Material.BOOK, true),
