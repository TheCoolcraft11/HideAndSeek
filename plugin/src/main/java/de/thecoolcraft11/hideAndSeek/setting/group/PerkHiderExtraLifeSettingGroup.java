    ...
    public List<SettingSpec> settings() {
        return List.of(
                new BooleanSettingSpec(
                        "perks.perk.hider_extra_life.enabled",
                        true,
                        "Enable Extra Life",
                ...
                new IntegerSettingSpec(
                        "perks.perk.hider_extra_life.cost",
                        200,
                        0,
                        10000,
                        "Cost of Extra Life",
                ...
                new LongSettingSpec(
                        "perks.perk.hider_extra_life.cooldown-ticks",
                        0L,
                        0L,
                        20000L,
                        "Purchase cooldown for Extra Life",
                        Material.CLOCK
                ),
                new IntegerSettingSpec(
                        "perks.perk.hider_extra_life.points-per-heart",
                        100,
                        1,
                        10000,
                        "Points required per absorption heart",
                        Material.GOLD_NUGGET
                ),
                new IntegerSettingSpec(
                        "perks.perk.hider_extra_life.max-hearts",
                        5,
                        1,
                        20,
                        "Maximum absorption hearts",
