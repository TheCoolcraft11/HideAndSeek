    ...
    public List<SettingSpec> settings() {
        return List.of(
                new BooleanSettingSpec(
                        "perks.perk.seeker_random_swap.enabled",
                        true,
                        "Enable Random Swap",
                ...
                new IntegerSettingSpec(
                        "perks.perk.seeker_random_swap.cost",
                        250,
                        0,
                        10000,
                        "Cost of Random Swap",
                ...
                new LongSettingSpec(
                        "perks.perk.seeker_random_swap.purchase-cooldown-ticks",
                        400L,
                        0L,
                        20000L,
                        "Purchase cooldown for Random Swap",
                        Material.CLOCK
                ),
                new IntegerSettingSpec(
                        "perks.perk.seeker_random_swap.blindness-ticks",
                        40,
                        0,
                        2000,
                        "Blindness duration for Random Swap",
                        Material.INK_SAC
                ),
                new BooleanSettingSpec(
                        "perks.perk.seeker_random_swap.exclude-hidden",
                        true,
                        "Exclude hidden hiders from Random Swap",
                        Material.TRIPWIRE_HOOK,
                        true
                ),
                new BooleanSettingSpec(
                        "perks.perk.seeker_random_swap.finite",
                        false,
                        "Whether Random Swap is finite",
                        Material.BARRIER,
                        true
                )
        );
